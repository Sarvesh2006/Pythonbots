...
if __name__ == "__main__":
    speak_text_cmd('Hello Mr. your name. This is JARVIS, as your Artificial Intelligence.')
    ...
    while True:
        ...
        if 'hello' in voice_note:
            ...
            speak_text_cmd('Bye, Mr. your name . Happy to help you . Have a good day')
            print('Bye, Mr.yourname. Happy to help you. Have a good day')
            exit()
